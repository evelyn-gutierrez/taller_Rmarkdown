...
output:
  slidy_presentation: 
    duration: 45
    footer: Evelyn Gutierrez, egutierreza@pucp.edu.pe
    highlight: haddock
    #number_sections: yes
    slide_level: null
    theme: cerulean
...
![](images/formatexport.png){width=80%}
...
Contiene 3 partes:
  ...
  3. Bloques de código: *códigos* encerrados entre triple tilde invertida (acentos agudos) ```` (Para crearlos rapidamente se puede usar *ctrl +alt + i*).
 
  
![](images/estructura.png){width=75%}

# Estructura de un documento RMarkdown {-}

![](images/bloques.png){width=85%}
...
![](images/yaml_ejemplo.png){width=70%}
...
1. **En bloques de código** (*chunks*): inician con ```{r} (donde r indique el lenguaje a utilizar, y se puede poner otros como: python, sql, ...)
